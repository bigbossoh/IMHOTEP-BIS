...
public class InvoiceCertificationServiceImpl implements InvoiceCertificationService {
    ...
    private InvoiceFneCertifyDto toDto(InvoiceFneCertify invoice) {
        ...
        Long customTaxes = invoice.getTotalCustomTaxes();
        Long totalAfterTaxes = invoice.getTotalAfterTaxes();
        Long totalDue = invoice.getTotalDue();
        dto.setTotalTTC(totalDue != null ? totalDue : safeAdd(totalAfterTaxes, customTaxes));
