...
public class SecurityConstant {
    ...
    public static final String ACTIVATION_EMAIL = "http://localhost:8287/" + APP_ROOT + "/auth/accountVerification";
    ...
    public static final String[] PUBLIC_URLS = {
            "/**/envoimail/**","/api/v1/image","/**/bail/**","/actuator/**","/**/categoriechambre/**",
            "/api/v1/auth/login", "/**/accountVerification/**", "/login","/**/prixparcategorie/**",
